...
sub execute {
    ...
    unless (fork()) {
        ...
        unless ($agent_pid) {
                ...
                my $input_thread = threads->create(
                    sub {
                        ...
                        while(my $line = <$agent_pipe>) {
                            my ($name, $value) = set_value_pair($line,
                                                                \%environment);
            ...
            say("SHENV_AGENT_INPUT=$agent_pipe_name; " .
                "export SHENV_AGENT_INPUT;");
            say("SHENV_AGENT_SOCKET=$agent_socket_name; " .
                "export SHENV_AGENT_SOCKET;");
